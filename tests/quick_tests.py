...
tests = {
    "Test 1 - Authority Check": (
        "What is the current AAPL stock price and what's the percentage change from yesterday?"
    ),
    "Test 2 - Capability Gap": "Extract text from this image file",
    "Test 3 - Numeric Computation": (
        "Get MSFT stock history for last 5 days and calculate the trend direction"
    ),
    "Test 4 - News Clustering": "Search for AI news and group them by topic",
    "Test 5 - Weather + News": (
        "Get weather in New York and search for related weather news"
    ),
