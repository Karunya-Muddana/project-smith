...
class SmithConfig(BaseSettings):
    ...
    default_timeout: float = Field(default=30.0, alias="SMITH_TIMEOUT")  # Reduced from 45s
    ...
    primary_model: str = Field(default="llama-3.3-70b-versatile", alias="SMITH_LLM_MODEL")
    ...
    llm_max_retries: int = Field(default=3, alias="SMITH_LLM_MAX_RETRIES")  # Reduced from 5
    backoff_max_seconds: float = Field(default=30.0, alias="SMITH_BACKOFF_MAX_SECONDS")  # Halved from 60s
